(function($, $document) {
	...
	/** A small delay function to allow time for dialogue to load completely before running script **/
    ...
    /** This function will pick the appropriate checkboxes to hide and show when any change is made in the multifield like add, remove, check or uncheck **/
