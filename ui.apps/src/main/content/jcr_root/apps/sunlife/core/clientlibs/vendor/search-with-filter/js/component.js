...
var TextBlock = /** @class */ (function (_super) {
    ...
    function TextBlock(element, options, bindings) {
        var _this = _super.call(this, element, TextBlock_1.ID, bindings) || this;
        _this.element = element;
        _this.options = options;
        _this.bindings = bindings;
        _this.options = coveo_search_ui_1.ComponentOptions.initComponentOptions(element, TextBlock_1, options);
        _this.bind.onRootElement(coveo_search_ui_1.QueryEvents.querySuccess, function (args) { return _this.handleQuerySuccess(args); });
        _this.bind.onRootElement(coveo_search_ui_1.QueryEvents.queryError, function () { return _this.handleQueryError(); });
        _this.bind.onRootElement(coveo_search_ui_1.QueryEvents.noResults, function (args) { return _this.handleNoResults(); });
        return _this;
    }
    TextBlock_1 = TextBlock;
    TextBlock.prototype.handleQueryError = function () {
        this.reset();
        TextBlock_1.hasResults = false;
    };
    TextBlock.prototype.handleNoResults = function () {
        this.reset();
        TextBlock_1.hasResults = false;
    };
    ...
    TextBlock.prototype.reset = function () {
        coveo_search_ui_1.$$(this.element).empty();
    };
    TextBlock.prototype.build = function () {
        this.renderTextBlock();
    };
    TextBlock.prototype.renderTextBlock = function () {
        var _a = this.options, ariaHidden = _a.ariaHidden, as = _a.as, content = _a.content, contentType = _a.contentType, overrideAriaHidden = _a.overrideAriaHidden;
        var classes = "text-block " + contentType;
        var attributes;
        ...
        var textBlockElement = coveo_search_ui_1.$$(as, attributes, content).el;
        coveo_search_ui_1.$$(this.element).append(textBlockElement);
    };
    var TextBlock_1;
    TextBlock.ID = 'TextBlock';
    TextBlock.options = {
        as: coveo_search_ui_1.ComponentOptions.buildStringOption({ defaultValue: 'p' }),
        content: coveo_search_ui_1.ComponentOptions.buildStringOption({ defaultValue: 'label' }),
        contentType: coveo_search_ui_1.ComponentOptions.buildStringOption({ defaultValue: '' }),
        constantlyVisible: coveo_search_ui_1.ComponentOptions.buildBooleanOption({ defaultValue: false }),
        ariaHidden: coveo_search_ui_1.ComponentOptions.buildBooleanOption({ defaultValue: false }),
        overrideAriaHidden: coveo_search_ui_1.ComponentOptions.buildBooleanOption({ defaultValue: false }),
    };
    TextBlock.hasResults = true;
