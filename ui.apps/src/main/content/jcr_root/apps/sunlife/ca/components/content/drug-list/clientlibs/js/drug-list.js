/*
https://bitbucket.sunlifecorp.com/projects/UI/repos/grs-drug-list/raw/src/drug-list.js?at=refs%2Fheads%2Fdevelop
 */
"use strict";
var drugListTotalBenefits = {
    ...
    setSpinner: function(state) {
        ...
        if (state == false) {
            console.log("hiding wait indicator");
            spinner.classList.add("no-display");
            spinner.hidden = true;
        } else {
            console.log("showing wait indicator");
