(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CoveoSunlifeSearchbox"] = factory(require("coveo-search-ui"));
	else
		root["CoveoSunlifeSearchbox"] = factory(root["Coveo"]);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SunlifeSearchbox = void 0;
var coveo_search_ui_1 = __webpack_require__(0);
var turbo_core_1 = __webpack_require__(1);
var SunlifeSearchbox = /** @class */ (function (_super) {
    __extends(SunlifeSearchbox, _super);
    function SunlifeSearchbox(element, options, bindings) {
        var _this = _super.call(this, element, SunlifeSearchbox_1.ID, bindings) || this;
        _this.element = element;
        _this.options = options;
        _this.bindings = bindings;
        _this.options = coveo_search_ui_1.ComponentOptions.initComponentOptions(element, SunlifeSearchbox_1, options);
        return _this;
    }
    SunlifeSearchbox_1 = SunlifeSearchbox;
    var SunlifeSearchbox_1;
    SunlifeSearchbox.ID = 'SunlifeSearchbox';
    SunlifeSearchbox.options = {};
    SunlifeSearchbox = SunlifeSearchbox_1 = __decorate([
        turbo_core_1.lazyComponent
    ], SunlifeSearchbox);
    return SunlifeSearchbox;
}(coveo_search_ui_1.Component));
exports.SunlifeSearchbox = SunlifeSearchbox;
