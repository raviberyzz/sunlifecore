...
(function(util) {
    ...
    util.constants = (function() {
        ...
        const returnObject = {
            ...
            templateString: {
                externalLinkIcon: `<i class="far fa-external-link icn-hover-hidden" aria-hidden="true"></i>`,
                internalLinkIcon: `<i class="far fa-arrow-circle-right icn-hover-hidden" aria-hidden="true"></i>`,
                pdfLinkIcon: `<i class="far fa-file-pdf icn-hover-hidden" aria-hidden="true"></i>`,
                externalLinkIconSolid: `<i class="fas fa-external-link icn-hover-show" aria-hidden="true"></i>`,
                internalLinkIconSolid: `<i class="fas fa-arrow-circle-right icn-hover-show" aria-hidden="true"></i>`,
