...
public class UGCServiceImpl implements UGCService {
  ...
  public void activate(UGCConfig ugcConfig) {
    ...
    logger.debug("Activated UGCConfig for NewsListing servlet :: {} , {}", this.ugcConfig,
        servicesMap);
  }

  /*
   * (non-Javadoc)
   * @see ca.sunlife.web.cms.source.services.UGCService#callWebService(java.lang. String,
