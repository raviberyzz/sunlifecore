...
public class AnalyticsServiceImp implements AnalyticsService {
    ...
    public void setUDOParameters(Page currentPage, String masterPagePath, String advancedPageType, String pageCategory, String pageSubCategory, String breadCrumb, JsonObject otherUDOTagsMap) throws LoginException, RepositoryException {
        ...
        try (ResourceResolver resolver = coreResourceResolver.getResourceResolver()) {
            ...
            otherUDOTagsMap.addProperty("page_category", pageCategory == null ? breadCrumb : pageCategory);
            otherUDOTagsMap.addProperty("page_subcategory", pageSubCategory == null ? "" : pageSubCategory);
        ...
        if (null != tags && tags.length > 0) {
            ...
            for (final String tag : tags) {
                ...
                if (array[1]
                    ...
                    otherUDOTagsMap = processUDOPath(path, otherUDOTagsMap);
                }
            }
        }
    ...
    @Override
    public void setUDOTagsForAdvisorPages(SlingHttpServletRequest request, String advisorType, JsonObject otherUDOTagsMap) {
        LOGGER.debug("Entry :: setUDOTagsForAdvisorPages :: ");
        ...
        LOGGER.debug("setUDOTagsForAdvisorPages :: advisorId :: {}, advisorType :: {}", advisorId,
                advisorType);
        LOGGER.debug("Exit :: setUDOTagsForAdvisorPages :: ");
    }
