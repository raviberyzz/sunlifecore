...
/**
 * @author mo92
 * The Class AdvisorDetailServiceImplTest
 * 
 */
...
public class AdvisorDetailServiceImplTest {
	...
	void testGetAdvisorDetails() throws ApplicationException, SystemException, IOException {
		...
		setUpConfig();
		when(restService.callGetWebService("/advisor/getDetails?language=EN&pageId=ADVISOR&encodedAdvisorId=1111111111111&clientVersion=1.0")).thenReturn(responseStr);
	...
	void testGetAdvisorDetailsWhenExceptionOccurs() throws ApplicationException, SystemException, IOException {
		setUpConfig();
		when(restService.callGetWebService("/advisor/getDetails?language=EN&pageId=ADVISOR&encodedAdvisorId=1012220000&clientVersion=1.0")).thenThrow(IOException.class);
