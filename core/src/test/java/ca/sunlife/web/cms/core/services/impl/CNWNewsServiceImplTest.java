...
public class CNWNewsServiceImplTest {
  ...
  void testGetCNWNewsOverview() throws IOException , ApplicationException , SystemException {
    ...
    Assert.assertEquals("Issue with date formatting , test failed" , "January 12, 2020" ,
        CNWNewsServiceImpl
            .getCNWNewsOverview("en" , "3" , getNewsCategories(new String [ ] { "773" }))
            .getReleases( ).getRelease( ).get(0).getReleaseDate( ));
    Assert.assertEquals("Issue with date formatting , test failed" , "12 janvier 2020" ,
        CNWNewsServiceImpl
            .getCNWNewsOverview("fr" , "3" , getNewsCategories(new String [ ] { "773" }))
            .getReleases( ).getRelease( ).get(0).getReleaseDate( ));
  }

  @ Test
  void testGetCNWNewsOverviewWhenDateFormatMapIsNotSet()
      throws IOException , ApplicationException , SystemException {
    String returnString = "{\"releases\":{\"release\":[{\"id\":\"1\",\"headline\":\"headline one\",\"releaseDate\":\"Sun, 12 Jan 2020 18:07:59 EST\",\"summary\":\"summary one\",\"body\":\"body one\"},{\"id\":\"2\",\"headline\":\"headline two\",\"releaseDate\":\"Sun, 12 Jan 2020 18:07:59 EST\",\"summary\":\"summary two\",\"body\":\"body two\"}],\"latestModified\":null,\"matching_count\":null,\"returned_count\":null}}";
    when(restService.callGetWebService(ArgumentMatchers.anyString( ))).thenReturn(returnString);
    setCnwNewsConfig(null , null);
    CNWNewsServiceImpl.activate(cnwNewsConfig);
    Assert.assertNull(CNWNewsServiceImpl.getCNWNewsOverview("en" , "3" ,
        getNewsCategories(new String [ ] { "773" })));
  }

  @ Test
  void testGetCNWNewsOverviewWhenDateParseException()
      throws IOException , ApplicationException , SystemException {
  ...
  @ Test
  void testGetCNWNewsWhenDateFormatMapIsNotSet()
      throws IOException , ApplicationException , SystemException {
    String returnString = "{\"releases\":{\"release\":[{\"id\":\"1\",\"headline\":\"headline one\",\"releaseDate\":\"Sun, 12 Jan 2020 18:07:59 EST\",\"summary\":\"summary one\",\"body\":\"body one\"},{\"id\":\"2\",\"headline\":\"headline two\",\"releaseDate\":\"Sun, 12 Jan 2020 18:07:59 EST\",\"summary\":\"summary two\",\"body\":\"body two\"}],\"latestModified\":\"Sun, 12 Jan 2020 18:07:59 EST\",\"matching_count\":\"77\",\"returned_count\":\"8\"}}";
    when(restService.callGetWebService(ArgumentMatchers.anyString( ))).thenReturn(returnString);
    setCnwNewsConfig(null , null);
  ...
  @ Test
  void testGetCNWNewsWhenDateParseException()
      throws IOException , ApplicationException , SystemException {
  ...
  @ Test
  void testGetCNWNewsWhenNewsItemsAreLessThanTen()
      throws IOException , ApplicationException , SystemException {
  ...
  @ Test
  void testGetCNWNewsToTestFirstPageBreak()
      throws IOException , ApplicationException , SystemException {
  ...
  @ Test
  void testGetCNWNewsToTestSecondPageBreak()
      throws IOException , ApplicationException , SystemException {
  ...
  @ Test
  void testGetCNWNewsWhenCnwServiceIsDown()
      throws IOException , ApplicationException , SystemException {
    when(restService.callGetWebService(ArgumentMatchers.anyString( )))
        .thenThrow(new IOException( ));
    CNWNewsServiceImpl.activate(cnwNewsConfig);
    Assertions.assertThrows(IOException.class , () -> {
      CNWNewsServiceImpl.getCNWNews("en" , "testpage_URL" , "5" , "2020" , "10" ,
          getNewsCategories(new String [ ] { "774" }));
    });
  }

  @ Test
  void testGetCNWNewsDetails()
    ...
    CNWNewsServiceImpl.activate(cnwNewsConfig);
    when(restService.callGetWebService(ArgumentMatchers.anyString( ))).thenReturn(returnString);
    String releaseDate = CNWNewsServiceImpl.getCNWNewsDetails("testid" , "en").getRelease( )
        .getReleaseDate( );
