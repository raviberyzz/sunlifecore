...
public class CNWNewsServiceImplTest {
	...
	void testGetCNWNewsOverview() throws IOException, ApplicationException, SystemException {
		...
		CNWNewsServiceImpl.activate(cnwNewsConfig);
		Assert.assertEquals("Issue with date formatting , test failed", "January 12, 2020", CNWNewsServiceImpl.getCNWNewsOverview("en", "3", getNewsCategories(new String[] { "773" })).getReleases().getRelease().get(0).getReleaseDate());
		Assert.assertEquals("Issue with date formatting , test failed", "12 janvier 2020", CNWNewsServiceImpl.getCNWNewsOverview("fr", "3", getNewsCategories(new String[] { "773" })).getReleases().getRelease().get(0).getReleaseDate());
	}
	...
	void testGetCNWNewsOverviewWhenDateParseException() throws IOException, ApplicationException, SystemException {
		...
		when(restService.callGetWebService(ArgumentMatchers.anyString())).thenReturn(returnString);
		CNWNewsServiceImpl.activate(cnwNewsConfig);
		assertEquals(2, CNWNewsServiceImpl.getCNWNewsOverview("en", "3", getNewsCategories(new String[] { "773" })).getReleases().getRelease().size());
	}
	...
	void testGetCNWNews() throws IOException, ApplicationException, SystemException {
		...
		when(restService.callGetWebService(ArgumentMatchers.anyString())).thenReturn(returnString);
		CNWNewsServiceImpl.activate(cnwNewsConfig);
		News cnwNews = CNWNewsServiceImpl.getCNWNews("en", "testpage_URL", "3", "2019", "10", getNewsCategories(new String[] { "773" }));
		Assert.assertEquals(8, cnwNews.getPagination().getTotalPages());
		News cnwNewsFr = CNWNewsServiceImpl.getCNWNews("fr", "testpage_URL", "3", "2019", "10", getNewsCategories(new String[] { "773" }));
	...
	void testGetCNWNewsWhenNewsItemsAreLessThanTen() throws IOException, ApplicationException, SystemException {
		...
		when(restService.callGetWebService(ArgumentMatchers.anyString())).thenReturn(returnString);
		CNWNewsServiceImpl.activate(cnwNewsConfig);
		News cnwNews = CNWNewsServiceImpl.getCNWNews("en", "testpage_URL", "0", "2019", "10", getNewsCategories(new String[] { "773" }));
		Assert.assertEquals(2, cnwNews.getReleaseMain().getReleases().getRelease().size());
	}
	...
	void testGetCNWNewsToTestFirstPageBreak() throws IOException, ApplicationException, SystemException {
		...
		when(restService.callGetWebService(ArgumentMatchers.anyString())).thenReturn(returnString);
		CNWNewsServiceImpl.activate(cnwNewsConfig);
		News cnwNews = CNWNewsServiceImpl.getCNWNews("en", "testpage_URL", "1", "2019", "10", getNewsCategories(new String[] { "773" }));
		Assert.assertEquals(2, cnwNews.getReleaseMain().getReleases().getRelease().size());
	}
	...
	void testGetCNWNewsToTestSecondPageBreak() throws IOException, ApplicationException, SystemException {
		...
		when(restService.callGetWebService(ArgumentMatchers.anyString())).thenReturn(returnString);
		CNWNewsServiceImpl.activate(cnwNewsConfig);
		News cnwNews = CNWNewsServiceImpl.getCNWNews("en", "testpage_URL", "6", "2019", "10", getNewsCategories(new String[] { "773" }));
		Assert.assertEquals(2, cnwNews.getReleaseMain().getReleases().getRelease().size());
	}
	...
	void testGetCNWNewsWhenCnwServiceIsDown() throws IOException, ApplicationException, SystemException {
		when(restService.callGetWebService(ArgumentMatchers.anyString())).thenThrow(new IOException());
		CNWNewsServiceImpl.activate(cnwNewsConfig);
	...
	@Test
	void testGetCNWNewsDetailsWhenDateParseException() throws IOException, ParseException, ApplicationException, SystemException {
